...
# 👉 Yes, it is inbuilt — no pip install needed.
...
GENERAL_SKILLS = [
    ...
    "node", "node.js", "nodejs", "express", "expressjs", "django", "flask", "react", "angular", "vue", "next.js",
    "api", "rest", "graphql", "docker", "kubernetes", "aws", "azure", "gcp", "cloud",
    "linux", "git", "oop", "unit testing", "integration testing", "ci/cd", "microservices",
    "pandas", "numpy", "scikit-learn", "tensorflow", "pytorch", "machine learning", "ai", "artificial intelligence",
    ...
    "data preprocessing", "regression", "classification", "clustering", "model deployment", "deployment",
